...
extern pid_param_t curve_pid;// 弯道
extern pid_param_t straight_pid;// 直道
extern pid_param_t severe_curve_pid;// 急弯
extern pid_param_t speed_pid;
extern pid_param_t fast_speed_pid;
extern pid_param_t extreme_speed_pid;
...
int core1_main (void)
{
    ...
    //Screen Display
    mutexCpu0TFTIsOk = 0; // CPU1: 0占用/1释放 OLED
    ...
    //PID Init
    PidInit(&curve_pid);
    PidInit(&straight_pid);
    PidInit(&severe_curve_pid);
    PidInit(&speed_pid);
    PidInit(&fast_speed_pid);
    PidInit(&extreme_speed_pid);
...
//    straight_pid.ki = 0.5;
    straight_pid.kd = 4;
//    straight_pid.imax = 680;
    severe_curve_pid.kp = 12;
//    severe_curve_pid.ki = 0.01;
    severe_curve_pid.kd = 0.1;
//    severe_curve_pid.imax = 680;
    speed_pid.kp = 0.02118;
    speed_pid.kd = 0.01;
    fast_speed_pid.kp = 0.04236;
    fast_speed_pid.kd = 0.005;
    extreme_speed_pid.kp = 0.08472;
    extreme_speed_pid.kd = 0.0025;
